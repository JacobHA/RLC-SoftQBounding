...
def net_to_delta(gamma, rewards, dones, actions, next_q_values, curr_q_values):
...
def bounds(beta, gamma, rewards, dones, actions, next_q_values, curr_q_values):
    ...
    for (next_q_value, curr_q_value) in zip(next_q_values, curr_q_values):
        delta, delta_min, delta_max = net_to_delta(gamma, rewards, dones, actions, next_q_value, curr_q_value)
